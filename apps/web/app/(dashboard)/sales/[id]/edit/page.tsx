...
export default function EditSalePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      api.get<SaleData>(`/sales/${params.id}`),
    ])
      .then(([prods, custs, sale]) => {
        setProducts(prods);
        setCustomers(custs);
    ...
    <div className="mx-auto max-w-7xl">
      <div className="max-w-2xl">
        ...
        <div className="mt-6 mb-8">
          <h1 className="text-lg font-semibold tracking-tight text-foreground">Edit Sale</h1>
          <p className="text-[13px] text-muted-foreground mt-0.5">
            Update sale details. Product stock will be adjusted automatically.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select value={productId} onValueChange={(id) => setProductId(id)}>
              <SelectTrigger>
